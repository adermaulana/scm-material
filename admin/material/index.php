...
if(isset($_GET['hal']) == "hapus"){
  ...
  $hapus = mysqli_query($koneksi, "DELETE FROM data_material WHERE id_material = '$_GET[id]'");
   ...
   <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
      ...
      <div class="table-responsive col-lg-11">
        <a style="background-color : #3a5a40; color:white;" class="btn btn mb-3" href="tambah.php">Tambah Material Baru</a>
        <table id="myTable" class="table table-striped table-lg mt-3">
          ...
          <?php
                $no = 1;
                $tampil = mysqli_query($koneksi, "SELECT * FROM data_material ORDER BY id_material DESC");
            ...
            <tr>
                    ...
                    <td><?= $data[4]; ?></td>
                    <td>
                      <img src="../../<?= $data['gambar_material']; ?>" width="100" alt="">
                    </td> 
              <td>
                <div class="d-flex">
                  <a  href="edit.php?hal=edit&id=<?= $data['id_material']?>" class="badge bg-warning me-1"><span data-feather="edit"></span></a>
                  <a href="index.php?hal=hapus&id=<?= $data['id_material']?>" class="badge bg-danger border-0" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data?')"><span data-feather="x-circle"></span></a>
                </div>
              </td>
            </tr>
            <?php
