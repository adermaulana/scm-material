...
if(isset($_POST['simpan'])){
    $simpan = mysqli_query($koneksi, "INSERT INTO data_distributor (nama_distributor, alamat_distributor,telepon_distributor) VALUES ('$_POST[nama_distributor]','$_POST[alamat]','$_POST[telepon]')");
  ...
  <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
   ...
   <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Tambah Distributor Baru</h1>
      </div>
...
<div class="col-lg-8">
    <form method="post" class="mb-5" enctype="multipart/form-data">
        ...
        <label for="name" class="form-label">Nama Distributor</label>
            <input type="text" class="form-control" id="nama_pemasok" name="nama_distributor" required autofocus>
        </div>
         <div class="mb-3">
